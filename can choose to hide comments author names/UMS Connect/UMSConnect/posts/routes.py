...
from UMSConnect import db
from UMSConnect.models import Post, Comment, User
from UMSConnect.posts.forms import PostForm
...
def new_post():
    ...
    if form.validate_on_submit():
        post = Post(title=form.title.data, content=form.content.data, author=current_user, anonymous_comments=form.anonymous_comments.data)
        db.session.add(post)
        db.session.commit()
